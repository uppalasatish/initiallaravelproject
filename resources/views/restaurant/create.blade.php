        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('global.restaurant.title') }}
                </div>
                <div class="panel-body">
                    ...
                    <form action="{{ route("admin.restaurant.store") }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('number') ? 'has-error' : '' }}">
                            ...
                            <input type="number" id="number" name="number" class="form-control" value="" required>
                        ...
                        <div class="form-group {{ $errors->has('desc') ? 'has-error' : '' }}">
                            ...
                            <textarea type="text" id="desc" name="desc" class="form-control" value=""></textarea>
                            @if($errors->has('desc'))
                                <p class="help-block">
                                    {{ $errors->first('desc') }}
                                </p>
                        ...
                        <?php $filePath = asset('images/default-avatar.jpg'); ?>
                        <div class="form-group {{ $errors->has('profile_picture') ? 'has-error' : '' }}">
                            <label for="profile_picture">{{ trans('global.restaurant.fields.image') }}*</label>
                            <input type="file" id="profile_picture" name="profile_picture" class="form-control profile-picture" required><br><br>
